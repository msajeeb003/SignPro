    ...
    return (
        <header className="topbar">
            ...
            <div className="topbar-actions">
                ...
                <Link to="/upload" className="topbar-cta">
                    <Icon name="plus" />
                    Start new
                </Link>
                <div className="topbar-user">
                    ...
                    <button className="topbar-logout" onClick={logout} title="Sign out" aria-label="Sign out">
                        <Icon name="logout" />
                    </button>
                </div>
            </div>
                    ...
                    <Route path="/templates" element={
                        <ProtectedRoute>
                            <PlaceholderPage eyebrow="Coming soon"
                                ...
                                description="A library of NDAs, leases, employment contracts, and more is coming soon. For now, upload your own PDF or DOCX." />
                        </ProtectedRoute>
                    } />
